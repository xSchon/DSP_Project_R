...
\includegraphics{Schon_Smrecek_Project_R_files/figure-latex/unnamed-chunk-18-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data }\OtherTok{\textless{}{-}} \FunctionTok{map}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{40}\NormalTok{, }\ControlFlowTok{function}\NormalTok{(x) wages[}\FunctionTok{sort}\NormalTok{(}\FunctionTok{sample}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\FunctionTok{dim}\NormalTok{(wages)[}\DecValTok{1}\NormalTok{], }\AttributeTok{size =} \FloatTok{0.5}\SpecialCharTok{*}\FunctionTok{dim}\NormalTok{(wages)[}\DecValTok{1}\NormalTok{])),])}

\NormalTok{models }\OtherTok{\textless{}{-}} \FunctionTok{map}\NormalTok{(data, }\ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{lm}\NormalTok{(x}\SpecialCharTok{$}\NormalTok{hour\_wage }\SpecialCharTok{\textasciitilde{}}\NormalTok{ x}\SpecialCharTok{$}\NormalTok{educ))}
