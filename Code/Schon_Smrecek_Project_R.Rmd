...
Z grafu je zjavné, že priamka má výrazne stúpajúci charakter. Na základe krížovej validácie vidíme, že model je stabilný. Z boxplotu RSE vidíme, že priemerná RSE je približne rovnaká ako pre podmnožiny, tak aj pre celú množinu. Výsledky sme overili t-testom. Z toho jasne vyplýva, že zamietame $H_0$ v prospech $H_1$. Platí teda $H_1$: Vzťah medzi IQ a dĺžkou vzdelania **existuje**.
